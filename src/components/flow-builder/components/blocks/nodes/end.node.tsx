...
import EndNodePropertyPanel from "../sidebar/panels/node-properties/property-panels/end-property-panel";
...
export const metadata: RegisterNodeMetadata<EndNodeData> = {
  ...
  connection: { inputs: 1, outputs: 0 },
  available: false,
  defaultData: { label: "End", deletable: false, endMessage: "", showSummary: false },
  propertyPanel: EndNodePropertyPanel,
};