...
import StartNodePropertyPanel from "../sidebar/panels/node-properties/property-panels/start-property-panel";
...
export const metadata: RegisterNodeMetadata<StartNodeData> = {
  ...
  connection: { inputs: 0, outputs: 1 },
  available: false,
  defaultData: { label: "Start", deletable: false, metadata: [] },
